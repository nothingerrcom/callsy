...
export default function LoginPage() {
  ...
  return (
    <main className="h-screen bg-[#0a0a0a] flex overflow-hidden">
      <div className="w-1/2 bg-white rounded-[32px] my-2 mx-2 min-h-[calc(100vh-16px)] shadow-lg">
      </div>
      <div className="w-1/2 flex flex-col p-8 overflow-hidden relative">
        <div className="max-w-md mx-auto w-full mt-16">
          ...
          <div className="space-y-4">
            ...
            <button 
              onClick={handleLogin}
              disabled={loading}
              className="w-full mt-4 px-4 py-3 bg-white text-black font-medium rounded-[12px] hover:bg-gray-100 transition-colors flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {loading ? (
                <>
