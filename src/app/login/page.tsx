            ...
            {!isExiting && (
                ...
                >
                    ...
                    >
                        ...
                        <h1 className="text-black font-semibold text-6xl">Welcome Back!</h1>
                        <p className="text-black/50 font-medium text-2xl">How nice to see you again.</p>
                    </motion.div>
                    ...
                    >
                        <div className="max-w-md mx-auto w-full mt-16">
                            <h1 className="text-3xl font-bold mb-8 text-white text-center">Welcome to Callsy</h1>

                            <div className="space-y-4 mb-8">
                                <button
                                    disabled={loading}
                                    onClick={() => signIn("discord")}
                                    className="w-full cursor-pointer flex items-center justify-center gap-2 px-4 py-2.5 border border-gray-800 rounded-[12px] text-gray-300 bg-[#111111] hover:bg-[#1a1a1a] disabled:opacity-50 disabled:cursor-not-allowed"
                                >
                                ...
                                <button
                                    ...
                                    className="w-full flex cursor-pointer items-center justify-center gap-2 px-4 py-2.5 border border-gray-800 rounded-[12px] text-gray-300 bg-[#111111] hover:bg-[#1a1a1a] disabled:opacity-50 disabled:cursor-not-allowed"
                                >
                                    <svg className="w-5 h-5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div className="space-y-4">
                                ...
                                <button
                                    onClick={handleLogin}
                                    disabled={loading}
                                    className="w-full mt-4 px-4 cursor-pointer py-3 bg-white text-black font-medium rounded-[12px] hover:bg-gray-100 transition-colors flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
                                >
                                    {loading ? (
                                        <>
